...
/*
 * Created by JFormDesigner on Wed Jul 15 18:40:15 IRDT 2020
 */
...
public class Show_Bill extends JFrame {
	...
	private void button1ActionPerformed(ActionEvent e) throws Exception {
		...
		Bill bill = MAIN.READ_OBJECT(new File(path + "/" + textField1.getText() + "/Bills/" + textField2.getText()+".txt"));
		JOptionPane.showMessageDialog(rootPane , "date :\t" + bill.getDate() + "\nprice:\t" + bill.getPrice() + "\ntype :\t" +
									bill.getType());
	}
