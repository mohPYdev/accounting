...
/*
 * Created by JFormDesigner on Wed Jul 15 18:46:22 IRDT 2020
 */
...
public class Show_Fix extends JFrame {
	...
	private void button1ActionPerformed(ActionEvent e) throws Exception {
		...
		Double fix = MAIN.READ_OBJECT(new File(path + "/" + textField1.getText() + "/Attributes/fixes.txt"));
		JOptionPane.showMessageDialog(rootPane , "price :\t" + fix);
	}
